...
오늘도 집 정리를 간단히 이어나갔다.
6시 까지 책상만 대강 정리하고 다시 프로젝트를 만졌다.
이번에는 일기의 주제인 15분을 카운트 다운하는 기능을 만들었다.
처음에 시간이 업데이트가 되지 않았는데 GetBuilder과 update를 같이 하니 문제가 해결되었다.
집정리를 조금씩 하면서 코딩도 같이 해 나가야겠다.
